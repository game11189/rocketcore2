...
const char * const riscv_vect_names_abi[32] = {
...
/* Game Instructions */
//{"vect",       "64V",   "D,o,Z",  MATCH_VECT, MASK_VECT, match_opcode, 0 },
{"vadd",       "I",   "d,s,t",  MATCH_VADD, MASK_VADD, match_opcode, 0 },
{"vsub",       "I",   "d,s,t",  MATCH_VSUB, MASK_VSUB, match_opcode, 0 },
{"vlw",       "I",   "d,o(s)",  MATCH_VLW, MASK_VLW, match_opcode, 0 },
{"vsw",       "I",   "t,q(s)",  MATCH_VSW, MASK_VSW, match_opcode, 0 },

//{"vect",       "64V",   "Va,Vb,Vc",  MATCH_VECT, MASK_VECT, match_opcode, 0 },
//{"vect",       "64V",   "d,s,t",  MATCH_VECT, MASK_VECT, match_opcode, 0 }
